...
x_data = np.load('DeepONet-type/1d-smooth/f.npy')
y1 = np.load('DeepONet-type/1d-smooth/u1.npy')
y2 = np.load('DeepONet-type/1d-smooth/u2.npy')
...
x_test = np.load('DeepONet-type/1d-smooth/f_test_fine.npy')
y_test = np.load('DeepONet-type/1d-smooth/u_test.npy')
