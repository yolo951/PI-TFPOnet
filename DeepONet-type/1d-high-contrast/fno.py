...
x_data = np.load('DeepONet-type/1d-high-contrast/f.npy')
y1 = np.load('DeepONet-type/1d-high-contrast/u1.npy')
y2 = np.load('DeepONet-type/1d-high-contrast/u2.npy')
...
x_test = np.load('DeepONet-type/1d-high-contrast/f_test_fine.npy')
y_test = np.load('DeepONet-type/1d-high-contrast/u_test.npy')
