...
tfponet_loss = np.load('DeepONet-type/2d-smooth/saved_data/rel_l2_history.npy')
supervised_deeponet_loss = np.load('DeepONet-type/2d-smooth/saved_data/supervised_deeponet_rel_l2_history.npy')
unsupervised_deeponet_loss = np.load('DeepONet-type/2d-smooth/saved_data/unsupervised_deeponet_rel_l2_history.npy')
supervised_ionet_loss = np.load('DeepONet-type/2d-smooth/saved_data/supervised_ionet_rel_l2_history.npy')
unsupervised_ionet_loss = np.load('DeepONet-type/2d-smooth/saved_data/unsupervised_ionet_rel_l2_history.npy')
supervised_fno_loss = np.load('DeepONet-type/2d-smooth/saved_data/supervised_fno_rel_l2_history.npy')
unsupervised_fno_loss = np.load('DeepONet-type/2d-smooth/saved_data/unsupervised_fno_rel_l2_history.npy')

plt.plot(np.arange(0, len(tfponet_loss)*100, 100), tfponet_loss, linewidth=2.5, label='TFPONet(ours)', color='black', linestyle='-')
...
plt.yscale('log')
plt.savefig('DeepONet-type/2d-smooth/saved_data/2d-smooth_all_rel_l2_history.png')
plt.show()
...
fig = plt.figure()
plt.scatter(np.arange(0, T+1, dt_tfpnet*100), tfponet_loss[:int(T/(dt_tfpnet*100)+1)], label='TFPONet(ours)', color='black')
...
plt.savefig('DeepONet-type/2d-smooth/saved_data/2d-smooth_all_rel_l2_time.png')
plt.show()