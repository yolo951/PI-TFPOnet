...
np.save(r'DeepONet-type\2d-singular\loss_history.npy', loss_history)
np.save(r'DeepONet-type\2d-singular\rel_l2_history.npy', rel_l2_history)
torch.save(model.state_dict(), r'DeepONet-type\2d-singular\model_state.pt')
...
# plt.ylim(1e-5, 1e+2)
plt.yscale("log")
plt.savefig(r'DeepONet-type\2d-singular\2d_singular_loss.png')
# plt.show()
...
# plt.ylim(1e-3, 1e+2)
plt.yscale("log")
plt.savefig(r'DeepONet-type\2d-singular\2d_singular_l2.png')
plt.show()
