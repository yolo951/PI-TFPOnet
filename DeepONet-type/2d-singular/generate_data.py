...
if __name__ == '__main__':
    ...
    index = data['index']
    val = data['val']
    np.savez("DeepONet-type/2d-singular/saved_data/data.npz", f_total=f_total, B_total=B_total, C_total=C_total, up_total=up_total, index=index, val=val, u_test_fine=ut_fine[-ntest:], u_train_fine=ut_fine[:ntrain], f_fine=f_fine)