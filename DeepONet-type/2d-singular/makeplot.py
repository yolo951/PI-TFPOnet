...
tfponet_loss = np.load(r'DeepONet-type\2d-singular\saved_data\rel_l2_history.npy')
supervised_deeponet_loss = np.load(r'DeepONet-type\2d-singular\saved_data\supervised_deeponet_rel_l2_history.npy')
unsupervised_deeponet_loss = np.load(r'DeepONet-type\2d-singular\saved_data\unsupervised_deeponet_rel_l2_history.npy')
supervised_ionet_loss = np.load(r'DeepONet-type\2d-singular\saved_data\supervised_ionet_rel_l2_history.npy')
unsupervised_ionet_loss = np.load(r'DeepONet-type\2d-singular\saved_data\unsupervised_ionet_rel_l2_history.npy')
...
plt.savefig(r'DeepONet-type\2d-singular\saved_data\all_rel_l2_history.png')
plt.yscale('log')
plt.show()