...
np.save('DeepONet-type/2d-singular/saved_data/supervised_fno_loss_history.npy', mse_history)
np.save('DeepONet-type/2d-singular/saved_data/supervised_fno_rel_l2_history.npy', rel_l2_history)
torch.save(model.state_dict(), 'DeepONet-type/2d-singular/saved_data/supervised_fno_model_state.pt')
...
# plt.ylim(1e-3, 1e+2)
plt.yscale("log")
plt.savefig('DeepONet-type/2d-singular/saved_data/supervised_fno_l2.png')
plt.show()