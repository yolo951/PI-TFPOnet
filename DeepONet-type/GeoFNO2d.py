...
# Based on https://github.com/neuraloperator/Geo-FNO/blob/main/elasticity/elas_geofno_v2.py, we got the following code
...
class IPHI(nn.Module):
    def __init__(self, width=32):
        ...
        self.register_buffer('B', np.pi * torch.pow(2, torch.arange(0, self.width // 4, dtype=torch.float)).reshape(1, 1, 1, self.width // 4))
